...
class Steampunk(Reality):
    def __init__(self,kostkaid="00:16:53:07:F8:5B",homefilerankwheels=(0,0),filerankwheels=(0,0),filewheelr=1,rankwheelr=1,filewheeleng=100,rankwheeleng=100):
