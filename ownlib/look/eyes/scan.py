...
class cam(eye):
    def __init__(self,scnr3tupl,saveraw=None,savemod=None,showraw=True,showmod=True):
        self.scnr3tupl=scnr3tupl;self.saveraw=saveraw;self.savemod=savemod;self.savinr=saveraw is not None ;self.savinm=savemod is not None
    def __enter__(self):
